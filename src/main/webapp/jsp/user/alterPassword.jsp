						...
						<div class="row">
							<div class="col-xs-12">
								<div class="card">
									<div class="card card-success">
										<div class="card-header">
											<div class="card-title">
												<div class="title">
													<i class="fa fa-comments-o"></i> 修改密码</div>
											</div>
									...
									<div class="card-body">
										<form class="form-horizontal" style="padding-left:33%" action="${pageContext.request.contextPath}/alterPassword?userid=${sessionuser.userId}" method="post">
											<div class="form-group">
												<!--<label for="exampleInputName2" class="col-sm-2 control-label">姓名</label>
												<div class="col-sm-10" style="margin-top : 7px">
													${sessionuser.userEnName}
												</div>-->
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="password" name="oldpassword" class="form-control" id="inputPassword3" style="width:180px;">
												</div>
											</div>
											<div class="form-group">
												<label for="inputPassword3" class="col-sm-2 control-label">新密码</label>
												<div class="col-sm-10">
													<input type="password" name="password" class="form-control" id="inputPassword3" style="width:180px;">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="password" name="passwordagain" class="form-control" id="inputPassword3" style="width:180px;">
												</div>
											</div>
											...
											<div class="form-group">
												<div class="col-sm-offset-2 col-sm-10">
													...
													<input type="reset" value="取消" class="btn btn-default"></input>
