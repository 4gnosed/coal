						...
						<div class="row">
							<div class="col-xs-12">
								<div class="card">
									<div class="card card-success">
										<div class="card-header">
											<div class="card-title">
												<div class="title">
													<i class="fa fa-comments-o"></i> 用户修改</div>
											</div>
									...
									<div class="card-body">
										<!--表单提交-->
										<form class="form-horizontal" style="padding-left:33%" action="${pageContext.request.contextPath}/alterUser?userid=${user.userId}" method="post">

											<div class="form-group">
												<label for="exampleInputName2" class="col-sm-2 control-label">用户名</label>
												<div class="col-sm-10">
													<input type="text" class="form-control" id="exampleInputName2" style="width:180px;" value="${user.userName}" name="username">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="password" class="form-control" id="inputPassword3" style="width:180px;" value="${user.userPassword}" name="password">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" style="width:180px;" value="${user.userEnName}" name="enname">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" style="width:180px;" value="${user.userPhone}" name="phone">
												</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" style="width:180px;" value="${user.userAddress}" name="address">
												</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" style="width:180px;" value="${user.userEmail}" name="email">
												</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													...
													<c:forEach items="${companies}" var="m">
														<c:if test="${user.companyId == m.companyId}">

															<input type="text" readonly="true" class="form-control" style="width:180px;" value="${m.companyName}">
														</c:if>
													</c:forEach>
											...
											<div class="form-group">
												...
												<div class="col-sm-10">
													<c:if test="${user.roleId==1}">
														<input type="text" readonly="true" class="form-control" style="width:180px;" value="平台管理员">

													</c:if>
													<c:if test="${user.roleId==2}">
														<input type="text" readonly="true" class="form-control" style="width:180px;" value="公司员工">

													</c:if>
													<c:if test="${user.roleId==3}">
														<input type="text" readonly="true" class="form-control" style="width:180px;" value="公司经理">
											...
											<div class="form-group">
												<div class="col-sm-offset-2 col-sm-10">
													<input type="submit" value="修改" class="btn btn-default"></input>
