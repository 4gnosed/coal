...
<html>
	...
	<head>
		...
		<script>
			onload = function() {
				for(var i = 0; i < 4; i++) {
					var option = document.getElementById("selectTrans").options[i];
					if(option.value == $ {
							purchase.transId
						}) {
						option.setAttribute("selected", "true");
						document.getElementById("selectTrans").pre
						break;
					}
				}
			}
						...
						<div class="row  no-margin-bottom">
							...
							<div class="col-xs-12">
								...
								<!--
                                	表单提交
                                -->
								<form class="form-horizontal" action="${pageContext.request.contextPath}/alterOrSubmitBuy?purid=${purchase.purId}" method="post">
									<div class="card" style="margin-bottom: 10px;">
										...
										<div class="card-body">
											...
											<div class="form-group">
												...
												<div class="col-sm-3">
													<input type="date" value="${purchase.deadLine}" class="form-control " name="purdeadline">
												</div>
												<label for="inputPassword3" class="col-sm-2 control-label">单据编号：</label>
												<div class="col-sm-3">
													<input type="text" value="${purchase.docNumber}" readonly="true" class="form-control" name="purnumber">
												</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-3">
													<input type="text" value="${purchase.companyId}" class="form-control" readonly="true">
												</div>
												<label for="inputPassword3" class="col-sm-2 control-label">运输方式：</label>
												<div class="col-sm-3">
													<select class="col-sm-12" name="purtrans" id="selectTrans">
											...
											<div class="form-group">
												...
												<div class="col-sm-3">
													<select class="col-sm-12" name="purcoal1" id="selectCoal1">
												...
												<div class="col-sm-3">
													<select class="col-sm-12" name="purcoal2">
														<option value="1" id="selectCoal2">其他</option>
														<option value="2" id="selectCoal2">原煤</option>
														<option value="3" id="selectCoal2">混煤</option>
														<option value="4" id="selectCoal2">中煤</option>
														<option value="5" id="selectCoal2">泥煤</option>
													</select>
												</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-3">
													<select class="col-sm-12" name="purcash" id="selectCoal1">
														<option selected value="一票结算">一票结算</option>
														<option value="1">其他</option>
											...
											<div class="form-group">
												...
												<div class="col-sm-3">
													<input type="text" value="${purchase.quantity}" class="form-control" name="purquantity">
												</div>
												<label for="inputPassword3" class="col-sm-2 control-label">交货地点：</label>
												<div class="col-sm-3">
													<input type="text" value="${purchase.deliPlace}" class="form-control" name="purdeliplace">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-3">
													<input type="text" value="${purchase.priceCeiling}" class="form-control" name="purpriceceiling">
												</div>
												<label for="inputPassword3" class="col-sm-2 control-label">最低限价（元/卡.吨）：</label>
												<div class="col-sm-3">
													<input type="text" value="${purchase.priceBottom}" class="form-control" name="purpricebottom">
												</div>
											</div>
											<div class="form-group">
												<label for="inputPassword3" class="col-sm-2 control-label">限价说明：</label>
												<div class="col-sm-3">
													<input type="text" value="${purchase.priceStatement}" class="form-control" name="purpricestatement">
												</div>
												<label for="inputPassword3" class="col-sm-2 control-label">结付款方式：</label>
												<div class="col-sm-3">
													<input type="text" value="${purchase.payType}" class="form-control" name="purpaytype">
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-3">
													<div>
														...
														<input type="text" value="${purchase.appPromise}" name="puapppromis">
													</div>
												</div>
												...
												<div class="col-sm-3">
													<div>
														...
														<input type="text" value="${purchase.pricePromise}" name="purpricepromise">
													</div>
												</div>
											</div>
											<div class="form-group">
									...
									<div class="card" style="margin-bottom: 10px;">
										...
										<div class="card-body">
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" value="${purchase.receQnet}" class="form-control" name="purreceqnet">
												</div>
											</div>
											<div class="form-group">
												<label for="inputPassword3" class="col-sm-4 control-label">收到基全硫St,ar≤(%)：</label>
												<div class="col-sm-4">
													<input type="text" value="${purchase.receSt}" class="form-control" name="purrecest">
												</div>
											</div>
											<div class="form-group">
												<label for="inputPassword3" class="col-sm-4 control-label">全水分M≤(%)：</label>
												<div class="col-sm-4">
													<input type="text" value="${purchase.receM}" class="form-control" name="purrecem">
												</div>
											</div>
											<div class="form-group">
												<label for="inputPassword3" class="col-sm-4 control-label">收到基灰分Aar≤(%)：</label>
												<div class="col-sm-4">
													<input type="text" value="${purchase.receAar}" class="form-control" name="purreceaar">
												</div>
											</div>
											<div class="form-group">
												<label for="inputPassword3" class="col-sm-4 control-label">收到基挥发分Var(%)：</label>
												<div class="col-sm-4">
													<input type="text" value="${purchase.receVarMin}" class="col-sm-5" name="purrecevarmin">至

													<input type="text" value="${purchase.receVarMax}" class="col-sm-6" name="purrecevarmax" style="float: right;">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" value="${purchase.airMad}" class="form-control" name="purairmad">
												</div>
											</div>
											<div class="form-group">
												<label for="inputPassword3" class="col-sm-4 control-label">空干基全硫St,ad≤(%)：</label>
												<div class="col-sm-4">
													<input type="text" value="${purchase.airSt}" class="form-control" name="purairst">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" value="${purchase.airVadMin}" class="col-sm-5" name="purairmin">至

													<input type="text" value="${purchase.airVadMax}" class="col-sm-6" name="purairmax" style="float: right;">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" value="${purchase.driedQgr}" class="form-control" name="purdriedqgr">
												</div>
											</div>
											<div class="form-group">
												<label for="inputPassword3" class="col-sm-4 control-label">干基全硫St,d≤(%)：</label>
												<div class="col-sm-4">
													<input type="text" value="${purchase.driedSt}" class="form-control" name="purdriedst">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" value="${purchase.driedVadMin}" class="col-sm-5" name="purdriedmin">至

													<input type="text" value="${purchase.driedVadMax}" class="col-sm-6" name="purdriedmax" style="float: right;">
												</div>
											</div>
										</div>
									</div>
									...
									<div class="card">
										<div class="card-body">
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" value="${purchase.particleSize}" class="form-control" name="purparaticlesize">
												</div>
											</div>
											<div class="form-group">
												<label for="inputPassword3" class="col-sm-4 control-label">灰熔点ST(℃)≥：</label>
												<div class="col-sm-4">
													<input type="text" value="${purchase.ST}" class="form-control" name="purst">
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" value="${purchase.HGI}" class="form-control" name="purhgi">
												</div>
											</div>
											<div class="form-group">
												<label for="inputPassword3" class="col-sm-4 control-label">备注：</label>
												<div class="col-sm-4">
													<textarea class="form-control" rows="3" name="purremak">${purchase.remark}</textarea>
												</div>
											</div>
											<div class="form-group">
												<center>
													<input type="submit" class="btn btn-default" value="修改"></input>
